INSERT INTO da.pg_versions (ddl, version) VALUES
	 ('
	 CREATE SCHEMA da_{tenant_id};

CREATE TABLE da_{tenant_id}.artifact_type (
	id uuid NOT NULL,
	code text NOT NULL,
	"name" text NOT NULL,
...
INSERT INTO da_{tenant_id}.artifact_type (id,code,"name") VALUES
...
CREATE TABLE da_{tenant_id}.business_entity (
	id uuid NOT NULL,
	"name" text NOT NULL,
	tech_name text NULL,
...
CREATE TABLE da_{tenant_id}.business_entity_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	tech_name text NULL,
	definition text NULL,
...
CREATE TABLE da_{tenant_id}."comment" (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.comment_hist (
	id uuid NOT NULL,
	comment_text text NOT NULL,
	parent_comment_id uuid NULL,
	artifact_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.custom_attribute (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.custom_attribute_defelement (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	definition_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.custom_attribute_defelement_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	definition_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.custom_attribute_definition (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	"type" text NOT NULL,
...
CREATE TABLE da_{tenant_id}.custom_attribute_definition_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	"type" text NOT NULL,
...
CREATE TABLE da_{tenant_id}.custom_attribute_hist (
	id uuid NOT NULL,
	definition_id uuid NOT NULL,
	object_id uuid NOT NULL,
	object_type text NOT NULL,
...
CREATE TABLE da_{tenant_id}.data_asset (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	system_id uuid NULL,
...
CREATE INDEX data_asset_name_idx ON da_{tenant_id}.data_asset USING btree (name);

CREATE TABLE da_{tenant_id}.data_asset_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	system_id uuid NULL,
...
CREATE TABLE da_{tenant_id}."datatype" (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	created timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}."domain" (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	state text NOT NULL,
...
CREATE TABLE da_{tenant_id}.domain_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	state text NOT NULL,
...
CREATE TABLE da_{tenant_id}.dq_log (
	id serial4 NOT NULL,
...
CREATE TABLE da_{tenant_id}.dq_rule (
	id uuid NOT NULL,
	"name" text NOT NULL,
	rule_ref text NULL,
	history_start timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}.dq_rule_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	rule_ref text NULL,
	history_start timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}.dq_tasks (
	id uuid NOT NULL,
	"time" timestamp NULL,
	rule_id uuid NULL,
	state int4 NULL,
...
CREATE TABLE da_{tenant_id}.entity (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.entity_attribute (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.entity_attribute_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	entity_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.entity_attribute_to_sample_property (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.entity_attribute_type (
	id varchar(200) NOT NULL,
	"name" text NOT NULL,
	CONSTRAINT entity_attribute_type_pk PRIMARY KEY (id)
);

INSERT INTO da_{tenant_id}.entity_attribute_type (id,"name") VALUES
	 (''TEXT'',''Текстовый''),
...
CREATE TABLE da_{tenant_id}.entity_folder (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	parent_id uuid NULL,
...
CREATE TABLE da_{tenant_id}.entity_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	entity_folder_id uuid NULL,
...
CREATE TABLE da_{tenant_id}.entity_query (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.entity_query_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	query_text text NULL,
...
CREATE TABLE da_{tenant_id}.entity_sample (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	entity_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.entity_sample_property (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	path_type text NULL,
...
CREATE TABLE da_{tenant_id}.entity_sample_property_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	path_type text NULL,
...
CREATE TABLE da_{tenant_id}.entity_sample_to_dq_rule (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.enumeration (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.exceptions_log (
...
CREATE TABLE da_{tenant_id}."indicator" (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	calc_code text NULL,
...
CREATE TABLE da_{tenant_id}.indicator_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	calc_code text NULL,
...
CREATE TABLE da_{tenant_id}.indicator_type (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	created timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}.model_links (
	id uuid NOT NULL,
	artifact_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.model_nodes (
	id uuid NOT NULL,
	artifact_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.openlinage_log (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.openlinage_log_assertions (
...
CREATE TABLE da_{tenant_id}.openlinage_log_inputs (
	"name" varchar NULL,
	ns varchar NULL,
	id uuid NOT NULL,
	ol_id uuid NULL,
...
CREATE TABLE da_{tenant_id}.openlinage_log_outputs (
	"name" varchar NULL,
	ns varchar NULL,
	id uuid NOT NULL,
	ol_id uuid NULL,
...
CREATE TABLE da_{tenant_id}.product (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	history_start timestamp NULL,
...
CREATE TABLE da_{tenant_id}.product_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	state text NULL,
...
CREATE TABLE da_{tenant_id}.product_supply_variant (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	created timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}.product_type (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	created timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}.rating (
	id uuid NOT NULL,
	artifact_id uuid NOT NULL,
	artifact_type text NOT NULL,
...
CREATE TABLE da_{tenant_id}.recent_view (
	id uuid NOT NULL,
	user_id text NOT NULL,
	artifact_id uuid NOT NULL,
	artifact_type text NOT NULL,
...
CREATE TABLE da_{tenant_id}.reference (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.reference_hist (
	id uuid NOT NULL,
	source_id uuid NOT NULL,
	source_artifact_type text NOT NULL,
	target_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.rule_type (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	created timestamp NOT NULL,
...
CREATE TABLE da_{tenant_id}.steward (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	user_id int4 NULL,
...
CREATE TABLE da_{tenant_id}.steward_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	user_id int4 NULL,
...
CREATE TABLE da_{tenant_id}.steward_to_domain (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}."system" (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.system_connection (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.system_connection_param (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.system_folder (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	parent_id uuid NULL,
...
CREATE TABLE da_{tenant_id}.system_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	system_type text NOT NULL,
...
CREATE TABLE da_{tenant_id}.system_to_domain (
	id uuid NOT NULL,
	domain_id uuid NOT NULL,
	system_id uuid NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.system_type (
	id text NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	created timestamp NOT NULL,
...
INSERT INTO da_{tenant_id}.system_type (id,"name",description,created,creator,modified,modifier) VALUES
...
CREATE TABLE da_{tenant_id}.tag (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
...
CREATE TABLE da_{tenant_id}.tag_category (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	history_start timestamp NULL,
...
CREATE TABLE da_{tenant_id}.tag_category_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	history_start timestamp NULL,
...
CREATE TABLE da_{tenant_id}.tag_hist (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	tag_category_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.tag_to_artifact (
	id uuid NOT NULL,
	artifact_id uuid NOT NULL,
	artifact_type text NOT NULL,
...
CREATE INDEX idx_tag_to_artifact_hist_dates_1001 ON da_{tenant_id}.tag_to_artifact USING btree (history_start, history_end);
CREATE INDEX idx_tag_to_artifact_id_1001 ON da_{tenant_id}.tag_to_artifact USING btree (id);

CREATE TABLE da_{tenant_id}.tag_to_artifact_hist (
	id uuid NOT NULL,
	artifact_id uuid NOT NULL,
	artifact_type text NOT NULL,
	tag_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.task (
	id uuid NOT NULL,
	"name" text NOT NULL,
	description text NULL,
	system_connection_id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.task_run (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.user_to_domain (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.workflow (
	id uuid NOT NULL,
	"name" text NOT NULL,
...
INSERT INTO da_{tenant_id}.workflow (id,"name",description,created,creator,modified,modifier,workflow_type) VALUES
...
CREATE TABLE da_{tenant_id}.workflow_settings (
	artifact_type text NOT NULL,
...
INSERT INTO da_{tenant_id}.workflow_settings (artifact_type,artifact_action,process_definition_key,description,created,creator,modified,modifier,id) VALUES
...
CREATE TABLE da_{tenant_id}.workflow_state (
	state text NOT NULL,
	"name" text NOT NULL,
...
INSERT INTO da_{tenant_id}.workflow_state (state,"name",user_name) VALUES
...
CREATE TABLE da_{tenant_id}.workflow_task (
	id uuid NOT NULL,
	artifact_id uuid NOT NULL,
	artifact_type text NOT NULL,
...
CREATE TABLE da_{tenant_id}.workflow_task_action (
	id uuid NOT NULL,
...
CREATE TABLE da_{tenant_id}.workflow_task_action_param (
	id uuid NOT NULL,
...
CREATE OR REPLACE VIEW da_{tenant_id}."Tasks, queries and samples"
AS SELECT DISTINCT es.name AS "Entity Sample Name",
    ...
    ( SELECT tr.task_state
           FROM da_{tenant_id}.task_run tr
   ...
   FROM da_{tenant_id}.task t
     LEFT JOIN da_{tenant_id}.system_connection sc ON t.system_connection_id = sc.id
     LEFT JOIN da_{tenant_id}.system s ON sc.system_id = s.id
     LEFT JOIN da_{tenant_id}.system_connection_param scp ON sc.id = scp.system_connection_id
     LEFT JOIN da.connector con ON s.connector_id = con.id
     LEFT JOIN da.connector_param cp ON scp.connector_param_id = cp.id
     LEFT JOIN da_{tenant_id}.entity_query eq ON eq.id = t.query_id
     LEFT JOIN da_{tenant_id}.entity_sample es ON eq.id = es.entity_query_id
  WHERE es.id IS NOT NULL
  ORDER BY t.name, t.id, cp.display_name;

CREATE OR REPLACE VIEW da_{tenant_id}.connector_params
AS SELECT sc.name AS connection_name,
    cp.name AS param_name,
    scp.param_value,
    scp.system_connection_id
   FROM da_{tenant_id}.system_connection_param scp
     LEFT JOIN da.connector_param cp ON cp.id = scp.connector_param_id
     LEFT JOIN da_{tenant_id}.system_connection sc ON sc.id = scp.system_connection_id;

CREATE OR REPLACE VIEW da_{tenant_id}.dq_rule_tasks
AS SELECT r.id,
    s.id AS system_id,
    ...
    es.name AS entity_sample_name,
        CASE
            ...
            ELSE 0
        END AS is_crontab
   FROM da_{tenant_id}.entity_sample_to_dq_rule r
     LEFT JOIN da_{tenant_id}.dq_rule dr ON r.dq_rule_id = dr.id
     LEFT JOIN da_{tenant_id}.entity_sample es ON r.entity_sample_id = es.id
     LEFT JOIN da_{tenant_id}.entity_query eq ON es.entity_query_id = eq.id
     LEFT JOIN da_{tenant_id}.entity e ON e.id = eq.entity_id
     LEFT JOIN da_{tenant_id}.task t ON t.query_id = eq.id
     LEFT JOIN da_{tenant_id}.indicator i ON i.id = r.indicator_id
     LEFT JOIN da_{tenant_id}.product p ON p.id = r.product_id
     LEFT JOIN da_{tenant_id}.system s ON s.id = eq.system_id
     LEFT JOIN da_{tenant_id}.data_asset da ON r.asset_id = da.id
 ...
 CREATE OR REPLACE FUNCTION da_{tenant_id}.provide_parent_name(parent_id uuid)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
declare
...
begin
  	...
  	from da_{tenant_id}.openlinage_log dq
	left join da_{tenant_id}.openlinage_log_inputs oli on oli.ol_id = dq.id 
	left join da_{tenant_id}.openlinage_log_outputs olo  on olo.ol_id = dq.id
	left join da_{tenant_id}.data_asset dai on   dai.id = uuid(oli.ns)
	left join da_{tenant_id}.system sdai on   sdai.id = dai.system_id 
	left join da_{tenant_id}.entity edai on   edai.id = dai.entity_id
	left join da_{tenant_id}.data_asset dao on dao.id = uuid(olo.ns)
	left join da_{tenant_id}.system sdao on   sdao.id = dao.system_id 
	  ...
	  select  dq.run_id  into rec from da_{tenant_id}.openlinage_log dq 
	...
	left join da_{tenant_id}.data_asset dao on dao.id = uuid(olo.ns)
	left join da_{tenant_id}.system sdao on   sdao.id = dao.system_id 
	left join da_{tenant_id}.entity edao on   edao.id = dao.entity_id
...
CREATE OR REPLACE VIEW da_{tenant_id}.openlinage_log_assertions_monitor
AS SELECT
        CASE
    ...
    t.assertion,
    t.state
   FROM da_{tenant_id}.openlinage_log_assertions t
     LEFT JOIN da_{tenant_id}.entity_sample_to_dq_rule estdr ON estdr.id = t.rule_id
     LEFT JOIN da_{tenant_id}.dq_rule dr ON dr.id = estdr.dq_rule_id
     LEFT JOIN da_{tenant_id}.openlinage_log ol ON ol.id = t.ol_id;

CREATE OR REPLACE VIEW da_{tenant_id}.openlinage_log_monitor
AS SELECT
        CASE
            WHEN (EXISTS ( SELECT 1
               FROM da_{tenant_id}.openlinage_log ol1
   ...
   FROM ( SELECT ( SELECT min(a.state::text) AS min
            ...
            dq.event_type,
            dq.event_time,
            da_{tenant_id}.provide_parent_name(dq.run_id) AS full_name,
            ...
            da_{tenant_id}.provide_parent_name(dq.run_id) AS system_producer_parent,
           ...
           FROM da_{tenant_id}.openlinage_log dq
             LEFT JOIN da_{tenant_id}.openlinage_log_inputs oli ON oli.ol_id = dq.id
             LEFT JOIN da_{tenant_id}.openlinage_log_outputs olo ON olo.ol_id = dq.id
             LEFT JOIN da_{tenant_id}.data_asset dai ON dai.id = oli.ns::uuid
             LEFT JOIN da_{tenant_id}.system sdai ON sdai.id = dai.system_id
             LEFT JOIN da_{tenant_id}.data_asset dao ON dao.id = olo.ns::uuid
             LEFT JOIN da_{tenant_id}.system sdao ON sdao.id = dao.system_id
             LEFT JOIN da_{tenant_id}.domain daod ON daod.id = dao.domain_id
             LEFT JOIN da_{tenant_id}.domain daid ON daid.id = dai.domain_id
          WHERE dq.event_type::text = ''START''::text
          ORDER BY dq.run_id, dq.event_time) t;

CREATE OR REPLACE VIEW da_{tenant_id}.openlinage_log_monitor_draft
AS SELECT t.state_name,
    ...
    t.output_asset_id,
    t.input_asset_id
   FROM da_{tenant_id}.openlinage_log_monitor t
  WHERE t.parent_run_id IS NULL;

CREATE OR REPLACE VIEW da_{tenant_id}."Атрибуты в активах"
AS SELECT asset.name AS "Имя актива",
    ...
    atr.modifier,
    atr.id
   FROM da_{tenant_id}.custom_attribute atr
     LEFT JOIN da_{tenant_id}.data_asset asset ON asset.id = atr.object_id
     LEFT JOIN da_{tenant_id}.custom_attribute_definition def ON atr.definition_id = def.id
     LEFT JOIN da_{tenant_id}.custom_attribute_defelement defelem ON atr.def_element_id = defelem.id
  WHERE atr.object_type = ''data_asset''::text;

CREATE OR REPLACE VIEW da_{tenant_id}."Таски и коннекшены"
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.business_entity_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
begin
   if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.business_entity be where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.business_entity where id = new.id;
        ...
        insert into da_{tenant_id}.business_entity_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.comment_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.comment where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.comment_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.custom_attribute_defelement_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.custom_attribute_defelement where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.custom_attribute_defelement_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.custom_attribute_definition_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.custom_attribute_definition where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.custom_attribute_definition_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.custom_attribute_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.custom_attribute where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.custom_attribute_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.data_asset_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
begin
   if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.data_asset where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.data_asset where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		if (old.state = ''PUBLISHED'') then
        ...
        insert into da_{tenant_id}.data_asset_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.domain_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
begin 
	if (TG_OP = ''UPDATE'') then
		select max(version_id) into max_version_id from da_{tenant_id}.domain where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.domain where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		if (old.state = ''PUBLISHED'') then
		...
		insert into da_{tenant_id}.domain_hist 
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.dq_rule_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
begin
   if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.dq_rule be where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.dq_rule where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		if (old.state = ''PUBLISHED'') then
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.entity_attribute_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.entity_attribute where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.entity_attribute_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.entity_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare
...
begin
   if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.entity where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.entity where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		if (old.state = ''PUBLISHED'') then
        ...
        insert into da_{tenant_id}.entity_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.entity_query_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
begin
    if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.entity_query where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.entity_query where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		if (old.state = ''PUBLISHED'') then
        ...
        insert into da_{tenant_id}.entity_query_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.entity_sample_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.entity_sample where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.entity_sample_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.entity_sample_property_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.entity_sample_property where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.entity_sample_property_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.indicator_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
...
begin
   if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.indicator where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.indicator where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		if (old.state = ''PUBLISHED'') then
   		...
   		insert into da_{tenant_id}.indicator_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.product_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare 
...
begin 
	if (TG_OP = ''UPDATE'') then
		select max(version_id) into max_version_id from da_{tenant_id}.product where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.product where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		...
		insert into da_{tenant_id}.product_hist 
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.provide_end_time(id_offer uuid)
...
begin
   ...
   into rec                                   
   from da_{tenant_id}.openlinage_log
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.provide_full_name(id_offer uuid, full_name text)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
declare
...
begin
   ...
   into rec                                   
   from da_{tenant_id}.openlinage_log_monitor_draft
   where run_id  = id_offer and event_type = ''START'';
   
   if rec.parent_run_id is null then                       
    return rec.system_producer::text ;                          
   else
    return da_{tenant_id}.provide_full_name(rec.parent_run_id,rec.system_producer::text + ''/''+ full_name ); 
   end if;
end;
$function$
;
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.steward_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.steward where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.steward_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.system_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
declare
...
begin
    if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.system where id = new.id;
		select max(history_id) into max_history_id from da_{tenant_id}.system where id = new.id;
		new.history_id = max_history_id + 1;
		new.history_start = CURRENT_TIMESTAMP;
		new.history_end = ''9999-12-30'';
		new.modified = CURRENT_TIMESTAMP;
        ...
        insert into da_{tenant_id}.system_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.tag_category_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.tag_category where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.tag_category_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.tag_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.tag where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.tag_hist
...
CREATE OR REPLACE FUNCTION da_{tenant_id}.tag_to_artifact_history()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
        declare
        ...
        begin
        if (TG_OP = ''UPDATE'') then
        select max(version_id) into max_version_id from da_{tenant_id}.tag_to_artifact where id = new.id;
        new.version_id = max_version_id + 1;
        new.history_start = CURRENT_TIMESTAMP;
        new.history_end = ''9999-12-30'';

        insert into da_{tenant_id}.tag_to_artifact_hist
...
update
    on
    da_{tenant_id}.business_entity for each row execute function da_{tenant_id}.business_entity_history();
...
update
    on
    da_{tenant_id}.comment for each row execute function da_{tenant_id}.comment_history();
...
update
    on
    da_{tenant_id}.custom_attribute for each row execute function da_{tenant_id}.custom_attribute_history();
...
update
    on
    da_{tenant_id}.custom_attribute_defelement for each row execute function da_{tenant_id}.custom_attribute_defelement_history();
...
update
    on
    da_{tenant_id}.custom_attribute_definition for each row execute function da_{tenant_id}.custom_attribute_definition_history();
...
update
    on
    da_{tenant_id}.data_asset for each row execute function da_{tenant_id}.data_asset_history();
...
update
    on
    da_{tenant_id}.domain for each row execute function da_{tenant_id}.domain_history();
...
update
    on
    da_{tenant_id}.dq_rule for each row execute function da_{tenant_id}.dq_rule_history();
...
update
    on
    da_{tenant_id}.entity for each row execute function da_{tenant_id}.entity_history();
...
update
    on
    da_{tenant_id}.entity_attribute for each row execute function da_{tenant_id}.entity_attribute_history();
...
update
    on
    da_{tenant_id}.entity_query for each row execute function da_{tenant_id}.entity_query_history();
...
update
    on
    da_{tenant_id}.entity_sample for each row execute function da_{tenant_id}.entity_sample_history();
...
update
    on
    da_{tenant_id}.entity_sample_property for each row execute function da_{tenant_id}.entity_sample_property_history();
...
update
    on
    da_{tenant_id}.indicator for each row execute function da_{tenant_id}.indicator_history();
...
update
    on
    da_{tenant_id}.product for each row execute function da_{tenant_id}.product_history();
...
update
    on
    da_{tenant_id}.steward for each row execute function da_{tenant_id}.steward_history();
...
update
    on
    da_{tenant_id}.system for each row execute function da_{tenant_id}.system_history();
...
update
    on
    da_{tenant_id}.tag for each row execute function da_{tenant_id}.tag_history();
...
update
    on
    da_{tenant_id}.tag_category for each row execute function da_{tenant_id}.tag_category_history();
