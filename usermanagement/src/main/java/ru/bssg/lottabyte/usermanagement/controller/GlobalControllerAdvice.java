...
public class GlobalControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleBaseControllerExceptions(UsernameNotFoundException exception) {
        ErrorModel errorModel = new ErrorModel();
        errorModel.setCode(ErrorCode.fromStatus(ru.bssg.lottabyte.core.model.HttpStatus.NOT_FOUND));
