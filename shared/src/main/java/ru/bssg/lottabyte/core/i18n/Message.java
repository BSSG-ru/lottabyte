...
public enum Message {
    ...
    LBE00121("Cannot remove Domain. Remove Business Entities from Domain first",
            "Не удается удалить домен. Сначала удалите глоссарий из домена", HttpStatus.BAD_REQUEST),
    ...
    LBE00301("Entity with id {0} not found", "Модель с идентификатором {0} не найден", HttpStatus.NOT_FOUND),
    LBE00302("Entity with id {0} not found", "Модель с идентификатором {0} не найден", HttpStatus.BAD_REQUEST),
    LBE00303("Entity name can not be empty", "Имя модели не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE00304("entity_folder with id {0} not found", "Папка модели с идентификатором {0} не найдена", HttpStatus.NOT_FOUND),
    LBE00305("Entity with name {0} already exists in entity_folder with id {1}",
            "Модель с именем {0} уже существует в папке с идентификатором {1}", HttpStatus.BAD_REQUEST),
    LBE00306("parent_entity_folder with id {0} not found", "Родительская папка модели с идентификатором {0} не найдена", HttpStatus.BAD_REQUEST),
    LBE00307("entity_folder with name {0} already exists in entity_folder with id {1}",
            "Папка модели с именем {0} уже существует в папке с идентификатором {1}", HttpStatus.BAD_REQUEST),
    LBE00308("entity_folder id can not be empty", "Идентификатор папки модели не может быть пустым", HttpStatus.BAD_REQUEST),
    ...
    LBE00310("entity_folder with id {0} contains child Entities, remove them before deletion",
            "Папка модели с идентификатором {0} содержит дочерние объекты, удалите их перед удалением", HttpStatus.BAD_REQUEST),
    LBE00311("entity_id can not be empty", "id модели не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE00312("entity_attribute with id {0} not found", "Атрибут модели с идентификатором {0} не найден", HttpStatus.NOT_FOUND),
    LBE00313("entity_attribute id can not be empty", "Идентификатор атрибута модели не может быть пустым", HttpStatus.BAD_REQUEST),
    ...
    LBE00315("Cannot remove Entity. Remove Data Assets linked with this Entity first: {0}",
            "Не удается удалить модель. Сначала удалите активы данных, связанные с этим объектом: {0}", HttpStatus.BAD_REQUEST),
    LBE00317("Cannot remove Entity. First remove entity_query for this entity: {0}",
            "Не удается удалить модель. Сначала удалите entity_query для этого объекта: {0}", HttpStatus.BAD_REQUEST),
    LBE00318("Cannot remove Entity. Remove Entity_sample linked with this Entity first: {0}",
            "Не удается удалить модель. Сначала удалите Entity_sample, связанный с этим объектом: {0}", HttpStatus.BAD_REQUEST),
    LBE00319(
            "Cannot remove Entity. Remove sample properties linked with this attribute first: {0}, properties {1}",
            "Не удается удалить модель. Сначала удалите свойства сэмпла, связанные с этим атрибутом: {0}, свойства {1}", HttpStatus.BAD_REQUEST),
    LBE00320(
            "Cannot remove Entity_query. Remove Entity_sample linked with this Entity_query first: {0}",
            "Не удается удалить запрос. Сначала удалите сэмплы, связанный с этим запросом: {0}", HttpStatus.BAD_REQUEST),
    LBE00321("Cannot remove Entity_query. Remove Task linked with this Entity_query first: {0}",
            "Не удается удалить запрос. Сначала удалите задачу, связанную с этим запросом: {0}", HttpStatus.BAD_REQUEST),
    LBE00322("Entity can not be added to systems {0}. You have no access to systems.",
            "Модель не может быть добавлен в системы {0}. У вас нет доступа к системам.", HttpStatus.BAD_REQUEST),
    LBE00323("Entity can not be removed from systems {0}. You have no access to systems.",
            "Модель не может быть удален из систем {0}. У вас нет доступа к системам.", HttpStatus.BAD_REQUEST),
    LBE00324("You have no access to Entity {0}.", "У вас нет доступа к модели {0}", HttpStatus.BAD_REQUEST),
    LBE00325("Can't change Entity, you have no access to current Entity {0}.",
            "Не удается изменить модель, у вас нет доступа к {0}", HttpStatus.BAD_REQUEST),
    LBE00326("Entity already has Draft version with id {0}, please modify Draft version",
            "У модели уже есть черновик версии с идентификатором {0}, пожалуйста, измените черновик версии", HttpStatus.BAD_REQUEST),
    ...
    LBE00328("Entity with id {0} and version_id {1} not found",
            "Модель с идентификатором {0} и version_id {1} не найден", HttpStatus.NOT_FOUND),
    LBE00329("The attribute of a data entity {0} cannot be deleted while it is in the indicator formula: {1} ",
            "Атрибут объекта данных {0} не может быть удален, пока он находится в формуле индикатора: {1} ", HttpStatus.BAD_REQUEST),
    LBE00330(
            "Cannot remove Entity Attribute. Remove entity_sample_property linked with this entity_attribute first: {0}",
            "Не удается удалить атрибут. Сначала удалите свойства сэмпла, связанные с этим атрибутом: {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE00332(
            "Cannot remove property. Remove entity attributes linked with this property first: {0}, attributes {1}",
            "Не удается удалить свойство. Сначала удалите атрибуты моделей, связанные с этим свойством сэмпла: {0}, атрибуты {1}", HttpStatus.BAD_REQUEST),

    LBE00401("entity_query with id {0} not found", "Запрос с идентификатором {0} не найден", HttpStatus.NOT_FOUND),
    LBE00402("entity_query id must not be null", "Идентификатор запроса не должен быть нулевым", HttpStatus.BAD_REQUEST),
    LBE00403("You have no access to Entity Query {0}", "У вас нет доступа к запросу {0}", HttpStatus.BAD_REQUEST),
    LBE00404("Entity Query name can not be empty", "Имя запроса не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE00405("Entity Query query text can not be empty", "Текст запроса не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE00406("Entity Query already has Draft version with id {0}, please modify Draft version",
            "Запрос уже имеет черновую версию с идентификатором {0}, пожалуйста, измените черновую версию", HttpStatus.BAD_REQUEST),
    LBE00407("Entity Query with id {0} and version_id {1} not found",
            "Запрос с id {0} и version_id {1} не найден", HttpStatus.NOT_FOUND),

    LBE00501("Data Asset name can not be empty", "Имя актива не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE00503("Data Asset with id {0} not found", "Актив с идентификатором {0} не найден", HttpStatus.NOT_FOUND),
    LBE00504("You have no access to Data Asset {0}", "У вас нет доступа к активу {0}", HttpStatus.BAD_REQUEST),
    LBE00505("Data Asset already has Draft version with id {0}, please modify Draft version",
            "Актив уже имеет черновую версию с идентификатором {0}, пожалуйста, измените черновую версию", HttpStatus.BAD_REQUEST),
    LBE00506("Data Asset with id {0} and version_id {1} not found",
            "Актив с идентификатором {0} и version_id {1} не найден", HttpStatus.NOT_FOUND),
    LBE00507("Can't delete asset, it is used in artifacts: {0}",
            "Не удается удалить актив, так как он используется в объектах: {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE00950("System with id {0} not found", "Система с идентификатором {0} не найдена", HttpStatus.BAD_REQUEST),
    ...
    LBE00909("Some Entity Samples exist in System, please remove Entity Samples before removing System",
            "В системе существуют некоторые образцы сэмплов, пожалуйста, удалите их перед удалением системы", HttpStatus.BAD_REQUEST),
    ...
    LBE00912("Some Entities exist in System, please remove Entities before removing System",
            "В системе существуют некоторые образцы моделей, пожалуйста, удалите образцы моделей перед удалением системы", HttpStatus.BAD_REQUEST),
    LBE00913("System Folder name can not be empty", "Имя папки систем не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE00914("System Folder with name {0} already exists in parent folder/root",
            "Папка систем с именем {0} уже существует в родительской папке/root", HttpStatus.BAD_REQUEST),
    ...
    LBE01002("tag_category id is not provided", "Идентификатор категории не указан", HttpStatus.BAD_REQUEST),
    LBE01003("Tag name can not be empty", "Имя тега не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE01004("tag_category with id {0} not found", "Категория с идентификатором {0} не найдена", HttpStatus.BAD_REQUEST),
    LBE01005("Tag with name {0} already exists", "Тег с именем {0} уже существует", HttpStatus.BAD_REQUEST),
    LBE01006("tag_category {0} has child tags", "Категория {0} имеет дочерние теги", HttpStatus.BAD_REQUEST),
    LBE01007("tag_category name is not provided", "Имя категории не указано", HttpStatus.BAD_REQUEST),
    LBE01008("tag_category with name {0} already exists", "Категория с именем {0} уже существует", HttpStatus.BAD_REQUEST),
    ...
    LBE01101("Connector with id {0} not found", "Соединение с идентификатором {0} не найдено", HttpStatus.NOT_FOUND),
    LBE01102("Connector with id {0} not found", "Соединение с идентификатором {0} не найдено", HttpStatus.BAD_REQUEST),

    LBE01201("system_connection with id {0} not found", "Подключение с идентификатором {0} не найдено", HttpStatus.NOT_FOUND),
    LBE01210("system_connection with id {0} not found", "Подключение с идентификатором {0} не найдено", HttpStatus.BAD_REQUEST),
    LBE01202("system_connection_param with id {0} not found",
            "Параметр подключения с идентификатором {0} не найден", HttpStatus.BAD_REQUEST),
    LBE01203("system_connection_id must not be null", "id подключения не должен быть нулевым", HttpStatus.BAD_REQUEST),
    ...
    LBE01206("System Connection is used in tasks, remove tasks first: {0}",
            "В задачах используется системное подключение, сначала удалите задачи: {0}", HttpStatus.BAD_REQUEST),
    LBE01207(
            "To remove system_connection_params with id: {0}, the required field must be false for connection_parameters",
            "Чтобы удалить параметры подключения с идентификатором: {0}, обязательное поле должно быть false для параметров подключения", HttpStatus.BAD_REQUEST),
    ...
    LBE01401("Task with id {0} not found", "Задача с идентификатором {0} не найдена", HttpStatus.BAD_REQUEST),
    LBE01402("Both schedule_params and schedule_types must be entered in the task",
            "В задаче должны быть введены расписание выполнения и его параметры", HttpStatus.BAD_REQUEST),
    ...
    LBE01404("entity_query {0} and system_connection {1} belong to different systems",
            "Запрос {0} и подключение {1} принадлежат разным системам", HttpStatus.BAD_REQUEST),
    ...
    LBE01410("Task schedule with id {0} not found", "Расписание задача с идентификатором {0} не найдено", HttpStatus.BAD_REQUEST),

    LBE01502("task_run with task_id {0} not found", "task_run с task_id {0} не найден", HttpStatus.BAD_REQUEST),
    LBE01503("Test task run error {0}", "Ошибка при проверке выполнения запроса {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE01703("Invalid artifact_type: {0}", "Недопустимый тип артефакта: {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE01904("DataAsset with that name already exists: {0}", "Актив с таким именем уже существует: {0}", HttpStatus.BAD_REQUEST),

    LBE02001("Sample with id {0} not found", "Сэмпл с идентификатором {0} не найден", HttpStatus.NOT_FOUND),
    LBE02002("Sample_property with id {0} not found", "Свойство сэмпла с идентификатором {0} не найдено", HttpStatus.NOT_FOUND),
    LBE02003("Sample_id is not set for the sample_property with id: {0}",
            "id сэмпла не задан для свойства с идентификатором: {0}", HttpStatus.BAD_REQUEST),
    LBE02004("Sample with name {0} already exist", "Сэмпл с именем {0} уже существует", HttpStatus.BAD_REQUEST),
    LBE02005("Sample with type: {0} must have type one of the following: json, xml, csv, table, text",
            "Сэмпл с типом: {0} должен иметь один из следующих типов: json, xml, csv, таблица, текст", HttpStatus.BAD_REQUEST),
    LBE02006("You have no access to Entity Sample {0}", "У вас нет доступа к сэмплу {0}", HttpStatus.BAD_REQUEST),
    LBE02007("Entity Sample Property {0} can not be linked to another Entity Sample",
            "Свойство сэмпла {0} не может быть связано с другим образцом объекта", HttpStatus.BAD_REQUEST),
    ...
    LBE02204("There is an Attribute with this name: {0} in entity_id: {1}",
            "В модели {1} есть атрибут с таким именем: {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE02501("Business Entity with id {0} not found", "Глоссарий с идентификатором {0} не найдена", HttpStatus.NOT_FOUND),
    LBE02502("Business Entity name can not be empty", "Название глоссария не может быть пустым", HttpStatus.BAD_REQUEST),
    LBE02503("Business Entity already has Draft version with id {0}, please modify Draft version",
            "У глоссария уже есть черновик версии с идентификатором {0}, пожалуйста, измените черновик версии", HttpStatus.BAD_REQUEST),
    ...
    LBE02505("Cannot delete business entity with id {0} which has children",
            "Нельзя удалить глоссарий {0}, так как у нее есть дочерние элементы", HttpStatus.BAD_REQUEST),
    LBE02506("Cannot archive business entity with id {0} which has children",
            "Нельзя архивировать глоссарий {0}, так как у нее есть дочерние элементы", HttpStatus.BAD_REQUEST),
    ...
    LBE02603("There are duplicates in the variants array: {0}", "В массиве вариантов есть дубликаты: {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE03103("Not all DataEntityAttribute exist: {0}", "Не все свойства модели существуют: {0}", HttpStatus.BAD_REQUEST),
    LBE03104("Not all indicator exist: {0}", "Не все индикаторы существуют: {0}", HttpStatus.BAD_REQUEST),
    LBE03105("Not all data assets exist and published: {0}", "Не все активы существуют и опубликованы: {0}", HttpStatus.BAD_REQUEST),
    ...
    LBE03203("The elements: {0} is missing in the directory: {1}", "Артефакты, используемые в формуле, отсутствуют в системе: {0}", HttpStatus.NOT_FOUND),
    ...
    LBE03207("Attributes: {0} are missing in related assets", "Данные атрибуты, используемые в формуле, отсутствуют в привязанных активах: {0}", HttpStatus.NOT_FOUND),
    ...
    LBE03420(
            "Cannot remove Entity_query. Remove product linked with this Entity_query first: {0}",
            "Не удается удалить запрос. Сначала удалите продукт, связанный с этим запросом: {0}", HttpStatus.BAD_REQUEST),
