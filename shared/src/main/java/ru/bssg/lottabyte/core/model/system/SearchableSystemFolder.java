...
public class SearchableSystemFolder extends SearchableArtifact {
    ...
    @Builder
    public SearchableSystemFolder(String id, Integer versionId, String name, String description, List<String> tags, String modifiedBy, LocalDateTime modifiedAt, String artifactType, LocalDateTime effectiveStartDate, LocalDateTime effectiveEndDate, List<SearchableCustomAttribute> customAttributes, List<String> domains, String parentId, List<ParentRelation> children) {
